...
import me.guardian.entity.TempleWallSegmentEntity;
...
public class TempleWallRenderer extends EntityRenderer<TempleWallSegmentEntity, FallingBlockRenderState> {

    public TempleWallRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(TempleWallSegmentEntity entity, FallingBlockRenderState state, float partialTicks) {
        super.extractRenderState(entity, state, partialTicks);
        if (state.movingBlockRenderState != null && ModBlocks.TEMPLE_GATE != null) {
            state.movingBlockRenderState.blockState = ModBlocks.TEMPLE_GATE.defaultBlockState();
    ...
    public void submit(FallingBlockRenderState state, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        poseStack.pushPose();
        // Center the 1x1 block model on the entity position and render a stack of 3 blocks high
